import { system, world, Player, ItemStack, Entity, EquipmentSlot } from "@minecraft/server";
...
/** @type {EquipmentSlot[]} */
const SLOTS = ["Head", "Legs", "Chest", "Feet", "Body"];
 ...
 */
export async function setPetEquipment(pet, slot, item) {
    ...
    if (item) {
        ...
        if (equipmentComponents.isDyeable)
